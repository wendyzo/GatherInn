...
const SOCIETIES = [
  { id: "1", name: "Photography Society", description: "Weekly shoots, dark-room workshops, and annual exhibition.", role: "executive" },
  { id: "2", name: "Robotics Club", description: "Hardware builds, coding sprints, and inter-uni competitions.", role: "project_owner" },
  { id: "3", name: "Drama Society", description: "Two full productions per semester and improv nights.", role: "member" },
];
...
const CONTRIBUTIONS = [
  { id: "e1",  name: "Annual Photography Exhibition",   event_date: d(8),   status: "active",    created_at: d(8),   society_name: "Photography Society", project_name: "Exhibition 2026", society_id: "1" },
  { id: "e2",  name: "Dark-Room Induction Workshop",    event_date: d(22),  status: "completed", created_at: d(22),  society_name: "Photography Society", project_name: "Workshops",       society_id: "1" },
  { id: "e3",  name: "Portrait Masterclass",            event_date: d(45),  status: "completed", created_at: d(45),  society_name: "Photography Society", project_name: "Workshops",       society_id: "1" },
  { id: "e4",  name: "Regional Robotics Championship",  event_date: d(3),   status: "planning",  created_at: d(3),   society_name: "Robotics Club",       project_name: "Competitions",    society_id: "2" },
  { id: "e5",  name: "Soldering Sprint",                event_date: d(60),  status: "completed", created_at: d(60),  society_name: "Robotics Club",       project_name: "Build Season",    society_id: "2" },
  { id: "e6",  name: "Sponsor Pitch Night",             event_date: d(90),  status: "completed", created_at: d(90),  society_name: "Robotics Club",       project_name: "Fundraising",     society_id: "2" },
  { id: "e7",  name: "Spring Production: Hamlet",       event_date: d(15),  status: "active",    created_at: d(15),  society_name: "Drama Society",       project_name: "Spring 2026",     society_id: "3" },
  { id: "e8",  name: "Improv Night",                    event_date: d(120), status: "completed", created_at: d(120), society_name: "Drama Society",       project_name: "Events",          society_id: "3" },
  { id: "e9",  name: "Auditions: Hamlet",               event_date: d(135), status: "completed", created_at: d(135), society_name: "Drama Society",       project_name: "Spring 2026",     society_id: "3" },
  { id: "e10", name: "Costume & Set Planning",          event_date: d(200), status: "completed", created_at: d(200), society_name: "Drama Society",       project_name: "Spring 2026",     society_id: "3" },
  { id: "e11", name: "Semester Kickoff Social",         event_date: d(270), status: "completed", created_at: d(270), society_name: "Photography Society", project_name: "Social",          society_id: "1" },
  { id: "e12", name: "Landscape Weekend Trip",          event_date: d(310), status: "cancelled", created_at: d(310), society_name: "Photography Society", project_name: "Trips",           society_id: "1" },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-sidebar/80 backdrop-blur sticky top-0 z-30">
        <div className="mx-auto max-w-7xl px-6 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-3">
            <span className="text-xs text-muted-foreground hidden sm:inline px-3">Viewing as guest</span>
            <Link to="/login">
      ...
      <div className="bg-primary/5 border-b border-primary/20">
        <div className="mx-auto max-w-7xl px-6 py-2 flex items-center gap-2 text-sm text-primary">
          ...
          <span>This is a demo with fictional data — <Link to="/login" className="underline underline-offset-2 font-medium">create a free account</Link> to start your own societies.</span>
        </div>
      </div>
        ...
        <div className="blueprint-bg space-y-12">
          ...
          <section>
            ...
            <div className="rounded-md border border-border bg-card p-5">
              ...
              <div className="flex flex-wrap gap-6 mt-4 pt-4 border-t border-border text-sm">
                ...
                <span><strong>2</strong> <span className="text-muted-foreground">leadership roles</span></span>
              </div>
            </div>
                ...
                <div key={e.id} className="relative pl-6 pb-6 group">
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">{e.society_name} · {e.project_name}</p>
                    </div>
          ...
          <section>
            <div className="flex items-end justify-between mb-6">
              ...
              <Link to="/login">
                <Button variant="outline" className="text-muted-foreground">Sign up to create</Button>
              </Link>
            </div>

            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {SOCIETIES.map((s) => (
                <div key={s.id} className="rounded-md border border-border bg-card p-6 cursor-default opacity-90">
          ...
          <section className="rounded-md border border-primary/20 bg-primary/5 p-8 text-center">
            ...
            <p className="text-muted-foreground text-sm mb-6">Create your own societies, manage events, and build your organisation's blueprint — for free.</p>
            <Link to="/login">
